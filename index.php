...
<script>
    function updateTanggal() {
        ...
        var bulan = date.getMonth() + 1; // Mengembalikan bulan dari 0-11, jadi perlu ditambah 1
        var tahun = date.getFullYear();

        var waktu = date.toLocaleTimeString();

        var tanggalFormatted = tanggal < 10 ? '0' + tanggal : tanggal;
        var bulanFormatted = bulan < 10 ? '0' + bulan : bulan;

        var tanggalText = tanggalFormatted + '-' + bulanFormatted + '-' + tahun;
        var waktuText = waktu;

        document.getElementById('tanggal').textContent = tanggalText;
        document.getElementById('waktu').textContent = waktuText;
    }

    setInterval(updateTanggal, 1000); // Pembaruan setiap detik
</script>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30">
                    <div class="analytics-content">
                        <h5>Jumlah Berkas Files</h5>
                        <?php
                        include('server/koneksi.php');
                        $sql    = "SELECT * FROM files";
                        $query    = mysqli_query($koneksi, $sql);
                        $count    = mysqli_num_rows($query);
                        echo "<h2 class='text-success'>$count Berkas</h2>";
                        ?>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30">
                    <div class="analytics-content">
                        ...
                        $query    = mysqli_query($koneksi, $sql);
                        $count    = mysqli_num_rows($query);
                        echo "<h2 class='text-success'>$count Admin</h2>";
                        ?>
